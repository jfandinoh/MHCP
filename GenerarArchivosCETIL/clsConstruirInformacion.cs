...
namespace GenerarArchivosCETIL
{
    public class clsConstruirInformacion
    {
		...
		public void EscribirArchivo(String nombreArchivo, PostgreSql postgreSql)
		{
			try
			{
				string path = Directory.GetCurrentDirectory() + @"\IndiciosPasivocol_" + DateTime.Now.Year.ToString("");
