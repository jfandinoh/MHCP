    ...
    public class clsCentrales
    {
        ...
        public string Proceso()
        {
            try
            {
                ...
                return "Se generan los archivos con la informacion de entidades centrales satisfactoriamente";
            }
            catch (Exception ex)
            {
        ...
        private void Activos(String database, String Esquema, PostgreSql postgreSql, NpgsqlTransaction npgsqlTransaction)
        {
            try 
            {
                ...
                clsActivos.ConstruirInformacion(postgreSql, npgsqlTransaction,"EC",string.Empty);
                clsActivos.ConstruirInformacionHl(postgreSql, npgsqlTransaction,"EC",string.Empty);
        ...
        private void Pensionados(String database, String Esquema, PostgreSql postgreSql, NpgsqlTransaction npgsqlTransaction)
        {
            try
            {
                ...
                cslPensionados.ConstruirInformacion(postgreSql, npgsqlTransaction, "EC", string.Empty);
                cslPensionados.ConstruirInformacionHl(postgreSql, npgsqlTransaction, "EC", string.Empty);
        ...
        private void Sustitutos(String database, String Esquema, PostgreSql postgreSql, NpgsqlTransaction npgsqlTransaction)
        {
            try
            {
                ...
                clsSustitutos.ConstruirInformacion(postgreSql, npgsqlTransaction, "EC", string.Empty);
        ...
        private void Retirados(String database, String Esquema, PostgreSql postgreSql, NpgsqlTransaction npgsqlTransaction)
        {
            try
            {
                ...
                cslRetirados.ConstruirInformacion(postgreSql, npgsqlTransaction,"EC",string.Empty);
                cslRetirados.ConstruirInformacionHl(postgreSql, npgsqlTransaction, "EC", string.Empty);
                cslRetirados.ConstruirInformacionHlAFP(postgreSql, npgsqlTransaction, "EC", string.Empty);
        ...
        private void EscribirArchivo(String nombreArchivo, String query, PostgreSql postgreSql, NpgsqlTransaction npgsqlTransaction)
        {
            try
            {
                string path = Directory.GetCurrentDirectory() + @"\asofondos\"+ DateTime.Now.Year.ToString()+ @"\centrales";
