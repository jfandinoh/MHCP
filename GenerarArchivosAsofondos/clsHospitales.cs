...
namespace GenerarArchivosAsofondos
{
    public class clsHospitales
    {
        ...
        public string Proceso()
        {
            ...
            {
                HospitalesCentrales();
                HospitalesDescentraslizadas();

                return "Se generan los archivos con la informacion de entidades hospitales satisfactoriamente";
            }
            catch (Exception ex)
            {
        ...
        private void HospitalesCentrales()
        {
            try
            {
                String database = "pc_datos_ultenvio_ac"; 
                ...
                try
                {
                    ...
                    {
                        ActivosEC(database, row["schemaname"].ToString(), postgreSql, npgsqlTransaction);
                        PensionadosEC(database, row["schemaname"].ToString(), postgreSql, npgsqlTransaction);
                        SustitutosEC(database, row["schemaname"].ToString(), postgreSql, npgsqlTransaction);
                        RetiradosEC(database, row["schemaname"].ToString(), postgreSql, npgsqlTransaction);
                    }
                }
                catch (Exception ex)
                {
                ...
                Console.WriteLine("Se generan los archivos con la informacion de hospitales centrales satisfactoriamente");
            }
            catch (Exception ex)
            {
                throw new Exception(string.Format("Error en proceso. {0}", ex.Message));
        ...
        private void HospitalesDescentraslizadas()
        {
            try
            {
                ...
                Console.WriteLine("Se generan los archivos con la informacion de hospitales descentralizadas satisfactoriamente");
            }
            catch (Exception ex)
            {
                throw new Exception(string.Format("Error en proceso. {0}", ex.Message));
        ...
        private DataTable ObtenerEsquemas(String database)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    "AND schemaname NOT IN('pc_datos_00','pc_datos_01', 'pc_datos_indice','public') " +
                    "ORDER BY 1";
        ...
        private void ActivosEC(String database, String Esquema, PostgreSql postgreSql, NpgsqlTransaction npgsqlTransaction)
        {
            try 
            {
                ...
                clsActivos.ConstruirInformacion(postgreSql, npgsqlTransaction, "ESE", "01");
                clsActivos.ConstruirInformacionHl(postgreSql, npgsqlTransaction, "ESE", "01");
            ...
            {
                throw new Exception(string.Format("Error en proceso de informacion Activos EC. {0}", ex.Message));
            }
        }

        private void PensionadosEC(String database, String Esquema, PostgreSql postgreSql, NpgsqlTransaction npgsqlTransaction)
        {
            try
            {
                ...
                cslPensionados.ConstruirInformacion(postgreSql, npgsqlTransaction, "ESE", "01");
                cslPensionados.ConstruirInformacionHl(postgreSql, npgsqlTransaction, "ESE", "01");
            ...
            {
                throw new Exception(string.Format("Error en proceso de informacion pensionados EC. {0}", ex.Message));
            }
        }

        private void SustitutosEC(String database, String Esquema, PostgreSql postgreSql, NpgsqlTransaction npgsqlTransaction)
        {
            try
            {
                ...
                clsSustitutos.ConstruirInformacion(postgreSql, npgsqlTransaction, "ESE", "01");
            ...
            {
                throw new Exception(string.Format("Error en proceso de informacion sustitutos EC. {0}", ex.Message));
            }
        }

        private void RetiradosEC(String database, String Esquema, PostgreSql postgreSql, NpgsqlTransaction npgsqlTransaction)
        {
            try
            {
                ...
                cslRetirados.ConstruirInformacion(postgreSql, npgsqlTransaction,"ESE","01");
                cslRetirados.ConstruirInformacionHl(postgreSql, npgsqlTransaction, "ESE", "01");
                cslRetirados.ConstruirInformacionHlAFP(postgreSql, npgsqlTransaction, "ESE", "01");
            ...
            {
                throw new Exception(string.Format("Error en proceso de informacion retirados EC. {0}", ex.Message));
            }
        }

        private void ActivosED(String database, String Esquema, PostgreSql postgreSql, NpgsqlTransaction npgsqlTransaction)
        {
            try
            {
                clsActivos clsActivos = new clsActivos();
                ...
                clsActivos.CargarInformacion(database, Esquema, postgreSql, npgsqlTransaction);
                clsActivos.CargarInformacionHl(database, Esquema, postgreSql, npgsqlTransaction);
                clsActivos.ConstruirInformacion(postgreSql, npgsqlTransaction, "ESE", "00");
                clsActivos.ConstruirInformacionHl(postgreSql, npgsqlTransaction, "ESE", "00");
            ...
            {
                throw new Exception(string.Format("Error en proceso de informacion Activos ED. {0}", ex.Message));
            }
        }

        private void PensionadosED(String database, String Esquema, PostgreSql postgreSql, NpgsqlTransaction npgsqlTransaction)
        {
            try
            {
                cslPensionados cslPensionados = new cslPensionados();
                ...
                cslPensionados.CargarInformacionHl(database, Esquema, postgreSql, npgsqlTransaction);
                cslPensionados.CargarInformacionHlFallecidos(database, Esquema, postgreSql, npgsqlTransaction);
                cslPensionados.ConstruirInformacion(postgreSql, npgsqlTransaction, "ESE", "00");
                cslPensionados.ConstruirInformacionHl(postgreSql, npgsqlTransaction, "ESE", "00");
            ...
            {
                throw new Exception(string.Format("Error en proceso de informacion pensionados ED. {0}", ex.Message));
            }
        }

        private void SustitutosED(String database, String Esquema, PostgreSql postgreSql, NpgsqlTransaction npgsqlTransaction)
        {
            try
            {
                clsSustitutos clsSustitutos = new clsSustitutos();
                ...
                clsSustitutos.CargarInformacion(database, Esquema, postgreSql, npgsqlTransaction);
                clsSustitutos.ConstruirInformacion(postgreSql, npgsqlTransaction, "ESE", "00");
            ...
            {
                throw new Exception(string.Format("Error en proceso de informacion sustitutos ED. {0}", ex.Message));
            }
        }

        private void RetiradosED(String database, String Esquema, PostgreSql postgreSql, NpgsqlTransaction npgsqlTransaction)
        {
            try
            {
                cslRetirados cslRetirados = new cslRetirados();
                ...
                cslRetirados.CargarInformacionHl(database, Esquema, postgreSql, npgsqlTransaction);
                cslRetirados.CargarInformacionAFP(database, Esquema, postgreSql, npgsqlTransaction);
                cslRetirados.ConstruirInformacion(postgreSql, npgsqlTransaction, "ESE", "00");
                cslRetirados.ConstruirInformacionHl(postgreSql, npgsqlTransaction, "ESE", "00");
                cslRetirados.ConstruirInformacionHlAFP(postgreSql, npgsqlTransaction, "ESE", "00");
            ...
            {
                throw new Exception(string.Format("Error en proceso de informacion retirados ED. {0}", ex.Message));
            }
        }
        ...
        private void EscribirArchivo(String nombreArchivo, String query, PostgreSql postgreSql, NpgsqlTransaction npgsqlTransaction)
        {
            try
            {
                string path = Directory.GetCurrentDirectory() + @"\asofondos\"+ DateTime.Now.Year.ToString()+ @"\hospitales";
